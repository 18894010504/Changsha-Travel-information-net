...
(function(a) {
    ...
    a.bounds = function(k) {
        ...
        return {left: n,top: m,width: l,height: j,right: n + l,bottom: m + j}
    };
    a.empty = function(j) {
        if (!j) {
            return
...
(function(p) {
    ...
    p.dragStyle = function(r, s) {
        p.css(r, {"-webkit-user-select": s,"-moz-user-select": s,"-ms-user-select": s,"-webkit-user-drag": s,"user-select": s,"user-drag": s})
    };
    p.transitionStyle = function(r, s) {
        if (navigator.userAgent.match(/5\.\d(\.\d)? safari/i)) {
            return
        }
        p.css(r, {"-webkit-transition": s,"-moz-transition": s,"-o-transition": s})
    };
    p.rotate = function(r, s) {
        p.transform(r, "rotate(" + s + "deg)")
    };
    function g() {
        m(b + ["", "div", "span", "a", "img", "ul", "li", "video"].join("," + b) + ", .jwclick", {margin: 0,padding: 0,border: 0,color: "#000000","font-size": "100%",font: "inherit","vertical-align": "baseline","background-color": "transparent","text-align": "left"});
        m(b + "ul", {"list-style": "none"})
    }
    g()
})(jwplayer.utils);
(function(a) {
...
(function(a) {
    a.parsers = {localName: function(b) {
            if (!b) {
                return ""
            } else {
                if (b.localName) {
...
(function(e) {
    ...
    g.parseGroup = function(o, q) {
        var n, l, j = [];
        function p(r) {
            var s = {zh: "Chinese",nl: "Dutch",en: "English",fr: "French",de: "German",it: "Italian",ja: "Japanese",pt: "Portuguese",ru: "Russian",es: "Spanish"};
            if (s[r]) {
                return s[r]
            }
            return r
                ...
                switch (c(n).toLowerCase()) {
                    case "content":
                        ...
                        if (h(n, "url")) {
                            ...
                            q.sources.push({file: h(n, "url"),type: h(n, "type"),width: h(n, "width"),label: h(n, "height") ? h(n, "height") + "p" : undefined})
                        }
                        break;
                    case "title":
                        q.title = a(n);
...
(function(e) {
    ...
    e.captions = function(H, u) {
        var N = H, v, w, K = {back: true,color: "#FFFFFF",fontSize: 15}, J = {fontFamily: "Arial,sans-serif",fontStyle: "normal",fontWeight: "normal",textDecoration: "none"}, R, Q, y, s = [], r = 0, S = false, F, B = new l.eventdispatcher();
        k.extend(this, B);
        function D() {
    ...
    h(a, {position: b,cursor: "pointer",width: f,height: f,overflow: d})
})(jwplayer.html5);
(function(a) {
    a.captions.renderer = function(q, g) {
        ...
        function n() {
            ...
            c({maxWidth: e + "px",fontSize: s + "px",lineHeight: r + "px",visibility: b});
            u = Math.round(e / 2 - f.clientWidth / 2);
            t = Math.round(j - f.clientHeight);
            c({left: u + "px",top: t + "px"})
        }
        function d() {
            var s = -1;
        ...
        function h() {
            ...
            g.appendChild(f);
            c({color: "#" + q.color.substr(-6),display: "block",fontFamily: q.fontFamily,fontStyle: q.fontStyle,fontWeight: q.fontWeight,height: "auto",margin: "0 0 0 0",padding: "3px 9px",position: "absolute",textAlign: "center",textDecoration: q.textDecoration,wordWrap: "break-word",width: "auto"});
            if (q.back) {
                c({background: "#000"})
            } else {
                c({textShadow: "-2px 0px 1px #000,2px 0px 1px #000,0px -2px 1px #000,0px 2px 1px #000,-1px 1px 1px #000,1px 1px 1px #000,1px -1px 1px #000,1px 1px 1px #000"})
            }
        }
        h();
        this.show = function() {
...
(function(q) {
    var m = q.html5, z = q.utils, c = q.events, g = c.state, t = z.css, C = z.transitionStyle, d = "button", s = "text", h = "divider", v = "slider", k = "relative", l = "absolute", b = "none", r = "block", A = "inline", p = "inline-block", n = "hidden", e = "left", F = "right", o = "100%", x = "opacity .15s, background .15s, visibility .15s", w = {display: b}, a = {display: E}, D = ".jwcontrolbar", u = false, j = true, B = null, E = undefined, y = window, f = document;
    m.controlbar = function(ai, aW) {
        var a7, Y, N = ao("divider", h), J = {margin: 8,maxwidth: 800,font: "Arial,sans-serif",fontsize: 11,fontcolor: parseInt("eeeeee", 16),fontweight: "bold",layout: {left: {position: "left",elements: [ao("play", d), N, ao("prev", d), ao("next", d), ao("divider", h, "nextdiv"), ao("elapsed", s)]},center: {position: "center",elements: [ao("time", v)]},right: {position: "right",elements: [ao("duration", s), N, ao("hd", d), ao("cc", d), N, ao("mute", d), ao("volume", v), N, ao("fullscreen", d)]}}}, aH, ba, aw, R, bq, aM, bA, an, a5, ax, bm, ak, bt, bk, aL, aB, Z, bj, ap, by, U, aX, aC, M, a0, a6 = u, aV = u, aY = 0, W = 0, bu = {play: "pause",mute: "unmute",fullscreen: "normalscreen"}, bF = {play: u,mute: u,fullscreen: u}, bf = {play: al,mute: bB,fullscreen: aT,next: a8,prev: aK}, bD = {time: bE,volume: aS}, O = {}, ah = this;
        function ao(bH, bJ, bI) {
            return {name: bH,type: bJ,className: bI}
        }
        function be() {
            aw = {};
            a7 = ai;
        ...
        function ad(bH) {
            switch (bH.newstate) {
                case g.BUFFERING:
                case g.PLAYING:
                    t(aU(".jwtimeSliderThumb"), {opacity: 1});
                    L("play", j);
                    break;
                case g.PAUSED:
                    if (!aV) {
                ...
                case g.IDLE:
                    L("play", u);
                    t(aU(".jwtimeSliderThumb"), {opacity: 0});
                    if (aw.timeRail) {
        ...
        function bx() {
            ...
            t("#" + aM, {height: R,bottom: a6 ? 0 : aH.margin});
            t(aU(".jwtext"), {font: aH.fontsize + "px/" + aI("background").height + "px " + aH.font,color: aH.fontcolor,"font-weight": aH.fontweight});
            t(aU(".jwoverlay"), {bottom: R});
            if (aH.maxwidth > 0) {
                t(aU(), {"max-width": aH.maxwidth})
            }
        }
        function aU(bH) {
            return "#" + aM + (bH ? " " + bH : "")
        ...
        function aZ() {
            var bJ = aq("capLeft");
            var bI = aq("capRight");
            var bH = aq("background", {position: l,left: aI("capLeft").width,right: aI("capRight").width,"background-repeat": "repeat-x"}, j);
            if (bH) {
                a1(bq, bH)
            }
            if (bJ) {
        ...
        function aq(bJ, bI, bK, bO, bL) {
            ...
            var bM;
            if (bK) {
                bM = {background: "url('" + bP.src + "') repeat-x " + bH,height: bL ? bP.height : E}
            } else {
                bM = {background: "url('" + bP.src + "') no-repeat" + bH,width: bP.width,height: bL ? bP.height : E}
            }
            bN.skin = bP;
        ...
        function bb(bH, bI, bJ) {
            ...
            t(bH, {width: bI.width,background: "url(" + bI.src + ") center no-repeat"});
            if (bJ.src) {
                t(bH + ":hover", {background: "url(" + bJ.src + ") center no-repeat"})
            }
        }
        function aj(bH) {
            return function() {
        ...
        function av(bH) {
            ...
            t(aU(".jw" + bH + " .jwrail"), {left: bM ? E : bT.width,right: bM ? E : bR.width,top: bM ? bT.height : E,bottom: bM ? bR.height : E,width: bM ? o : E,height: bM ? "auto" : E});
            aw[bH] = bJ;
            bJ.vertical = bM;
            if (bH == "time") {
        ...
        function a9(bI, bN, bM, bW) {
            ...
            for (var bR = 0; bR < bP.length; bR++) {
                ...
                if (bQ) {
                    ...
                    t(aU(".jwrailgroup." + bP[bR]), {"min-width": (bN ? E : bX.width + bV.width)});
                    bK.capSize = bN ? bX.height + bV.height : bX.width + bV.width;
                    t(aU("." + bQ.className), {left: bN ? E : bX.width,right: bN ? E : bV.width,top: bN ? bX.height : E,bottom: bN ? bV.height : E,height: bN ? "auto" : E});
                    if (bR == 2) {
                        bT = bK
                    }
                    aw[bS] = bK;
            ...
            if (bH) {
                t(aU("." + bH.className), {opacity: bI == "time" ? 0 : 1,"margin-top": bN ? bH.skin.height / -2 : E});
        ...
        function bv(bH) {
            if (aw.timeSliderThumb) {
                t(aU(".jwtimeSliderThumb"), {"margin-left": (aI("timeSliderThumb").width / -2)})
            }
            at(0);
            au(0)
        }
        function ac(bJ, bH, bL, bI) {
            var bK = "volume";
            t(aU(".jwvolume"), {width: aI(bK + "Rail").width + (bH ? 0 : aI(bK + "Cap" + bL).width + aI(bK + "Cap" + bI).width),height: bH ? (aI(bK + "Cap" + bL).height + aI(bK + "Rail").height + aI(bK + "RailCap" + bL).height + aI(bK + "RailCap" + bI).height + aI(bK + "Cap" + bI).height) : E});
            if (bH) {
        ...
        function bg() {
            ...
            a1(bq, S.right);
            bl();
            t(aU(".jwright"), {right: aI("capRight").width})
        }
        function bl() {
            if (aw.hd) {
        ...
        ah.redraw = function() {
            ...
            t(aU(".jwgroup.jwcenter"), {left: Math.round(z.parseDimension(S.left.offsetWidth) + bJ.width),right: Math.round(z.parseDimension(S.right.offsetWidth) + bI.width)});
            var bH = (bq.parentNode.clientWidth > aH.maxwidth), bK = a6 ? 0 : aH.margin;
            t(aU(), {left: bH ? "50%" : bK,right: bH ? E : bK,"margin-left": bH ? bq.clientWidth / -2 : E,width: bH ? o : E});
            aD()
        };
        function bo() {
        ...
        ah.audioMode = function(bH) {
            if (bH != a6) {
                a6 = bH;
                t(aU(".jwfullscreen"), {display: bH ? b : E});
                t(aU(".jwhd"), {display: bH ? b : E});
                t(aU(".jwcc"), {display: bH ? b : E});
                aR()
            }
        };
        ah.element = function() {
        ...
        function aI(bH) {
            ...
            if (bI) {
                ...
                return {width: 0,height: 0,src: "",image: E,ready: u}
            }
        }
        function a1(bH, bI) {
            bH.appendChild(bI)
    ...
    t(D, {position: l,opacity: 0});
    t(D + " span", {height: o});
    z.dragStyle(D + " span", b);
    t(D + " .jwgroup", {display: A});
    t(D + " span, " + D + " .jwgroup button," + D + " .jwleft", {position: k,"float": e});
    t(D + " .jwright", {position: l});
    t(D + " .jwcenter", {position: l});
    t(D + " buttoncontainer," + D + " button", {display: p,height: o,border: b,cursor: "pointer"});
    t(D + " .jwcapRight," + D + " .jwtimeSliderCapRight," + D + " .jwvolumeCapRight", {right: 0,position: l});
    t(D + " .jwcapBottom", {bottom: 0,position: l});
    t(D + " .jwtime", {position: l,height: o,width: o,left: 0});
    t(D + " .jwthumb", {position: l,height: o,cursor: "pointer"});
    t(D + " .jwrail", {position: l,cursor: "pointer"});
    t(D + " .jwrailgroup", {position: l,width: o});
    t(D + " .jwrailgroup span", {position: l});
    t(D + " .jwdivider+.jwdivider", {display: b});
    t(D + " .jwtext", {padding: "0 5px","text-align": "center"});
    t(D + " .jwoverlaytext", {padding: 3});
    t(D + " .jwvertical *", {display: r});
    C(D, x);
    C(D + " button", x);
    ...
    c.controller = function(j, k) {
        ...
        function v(U) {
            if (!u) {
                ...
                L.sendEvent(d.events.JWPLAYER_PLAYLIST_LOADED, {playlist: o.playlist});
                L.sendEvent(d.events.JWPLAYER_PLAYLIST_ITEM, {index: o.item});
                O();
        ...
        function N(U) {
            return function() {
                if (u) {
                    ...
                    B.push({method: U,arguments: arguments})
                }
            }
        }
        function F(W, V) {
...
(function(g) {
    ...
    g.display = function(u, M) {
        var t = u, F = u.skin, X, aa, J, w, H, S, V, r = k, ab = {}, Q = k, W = k, T = {}, s, K, Y = o.extend({showicons: d,bufferrotation: 45,bufferinterval: 100,fontcolor: "#ccc",overcolor: "#fff",fontsize: 15,fontweight: ""}, F.getComponentSettings("display"), M), O = new p.eventdispatcher();
        o.extend(this, O);
        function U() {
        ...
        this.clickHandler = Z;
        function R() {
            var ac = {font: Y.fontweight + " " + Y.fontsize + "px/" + (parseInt(Y.fontsize) + 3) + "px Arial,Helvetica,sans-serif",color: Y.fontcolor}, ad = {color: Y.overcolor};
        ...
        function I() {
            if (w) {
                ...
                m(N(j), {"background-image": undefined});
                L(j, k);
                H = S = 0
            }
        }
        ...
        function L(ac, ad) {
            ...
            if (T[ac] != ad) {
                T[ac] = ad;
                m(N(ac), {opacity: ad ? 1 : 0,visibility: ad ? "visible" : "hidden"})
            }
        }
        this.show = function() {
    ...
    m(a, {position: b,cursor: "pointer",width: h,height: h,overflow: e});
    m(a + " .jwpreview", {position: b,width: h,height: h,background: "no-repeat center",overflow: e,opacity: 0});
    m(a + ", " + a + " *", {"-webkit-transition": f,"-moz-transition": f,"-o-transition": f})
})(jwplayer.html5);
(function(d) {
    ...
    d.displayicon = function(K, F, v, C) {
        ...
        function w() {
            ...
            B = I("capRight");
            x = (R.width * B.width > 0);
            var S = {"background-image": "url(" + R.src + "), url(" + M.src + "), url(" + B.src + ")","background-position": "left,center,right","background-repeat": "no-repeat",padding: "0 " + B.width + "px 0 " + R.width + "px",height: M.height,"margin-top": M.height / -2};
            g(t(), S);
            if (M.overSrc) {
        ...
        function p() {
            ...
            g(t(".jwtext"), {display: (q.innerHTML && T) ? f : b});
            setTimeout(function() {
                ...
                g(t(), {"background-size": [R.width + U, S + U, B.width + U].join(",")}, true)
            }, 0)
        }
        this.element = function() {
            return z
    ...
    g(c, {display: "table",cursor: "pointer",position: "relative","margin-left": "auto","margin-right": "auto",top: "50%"}, true);
    g(c + " div", {position: "relative",display: "table-cell","vertical-align": "middle","background-repeat": "no-repeat","background-position": k});
    g(c + " div", {"vertical-align": "middle"}, true);
    g(c + " .jwtext", {color: "#fff",padding: "0 1px","max-width": "300px","overflow-y": "hidden","text-align": k,"-webkit-user-select": b,"-moz-user-select": b,"-ms-user-select": b,"user-select": b})
})(jwplayer.html5);
(function(e) {
    ...
    e.dock = function(z, I) {
        var C = z, B = {iconalpha: 0.75,iconalphaactive: 0.5,iconalphaover: 1,margin: 8}, u = l.extend({}, B, I), p = C.id + "_dock", v = C.skin, K, E = 0, s = {}, t = {}, w, F, J, D = this;
        function x() {
            D.visible = false;
            w = H("div", "jwdock");
        ...
        function y() {
            ...
            j(q(), {height: M.height,padding: u.margin});
            j(h, {height: M.height});
            j(q("button"), {width: M.width,cursor: "pointer",border: "none",background: M.src});
            if (N.src) {
                j(q("button:hover"), {background: N.src})
            }
            if (O.src) {
                j(q("button:active"), {background: O.src})
            }
            j(q("button>div"), {opacity: u.iconalpha});
            j(q("button:hover>div"), {opacity: u.iconalphaover});
            j(q("button:active>div"), {opacity: u.iconalphaactive});
            j(q(".jwoverlay"), {top: u.margin + M.height});
            G("capLeft", F);
            G("capRight", F);
            G("divider")
        }
        function G(O, N) {
            var M = A(O);
            j(q("." + O), {width: M.width,background: M.src});
            return H("div", O, N)
        }
        function q(M, N) {
            return "#" + p + " " + (M ? M : "")
        ...
        function A(M) {
            ...
            return N ? N : {width: 0,height: 0,src: ""}
        }
        D.redraw = function() {
            J = d(w)
        };
        function L(N) {
            ...
            Q.offsetX(0);
            R = d(w);
            j("#" + Q.element().id, {left: O.left - R.left + O.width / 2});
            M = d(Q.element());
            if (R.left > M.left) {
        ...
        D.addButton = function(M, U, Q, N) {
            ...
            T.id = p + "_" + N;
            T.innerHTML = "&nbsp;";
            j("#" + T.id, {"background-image": M});
            if (typeof Q == "string") {
                Q = new Function(Q)
            }
            P.addEventListener("click", Q);
            s[N] = {element: P,label: U,divider: O,icon: T};
            if (U) {
        ...
        function r() {
            j(h + " .capLeft, " + h + " .capRight", {display: E ? "block" : "none"})
        }
        x()
    };
    j(a, {position: "absolute",width: f,opacity: 0,});
    j(a + " > *", {height: f,"float": "left"});
    j(a + " > .jwoverlay", {height: "auto","float": "none","z-index": 99});
    j(h, {position: "absolute"});
    j(h + " button", {position: "relative"});
    j(h + " > *", {height: f,"float": "left"});
    j(h + " .divider", {display: "none"});
    j(h + " button ~ .divider", {display: "block"});
    j(h + " .capLeft, " + h + " .capRight", {display: "none"});
    j(h + " .capRight", {"float": "right"});
    j(h + " button > div", {left: 0,right: 0,top: 0,bottom: 0,margin: 5,position: "absolute","background-position": "center","background-repeat": "no-repeat"});
...
(function(a) {
    ...
    a.instream = function(C, q, B, D) {
        var x = {controlbarseekable: "always",controlbarpausable: true,controlbarstoppable: true,playlistclickable: true};
        ...
        this.jwInstreamDestroy = function(O) {
            ...
            H(d.JWPLAYER_INSTREAM_DESTROYED, {reason: (O ? "complete" : "destroyed")}, true);
            A.attachMedia();
            if (j == b.BUFFERING || j == b.PLAYING) {
                v.play();
...
(function(c) {
    ...
    b.defaults = {/*prefix: "http://www.wanwei.com.cn/templet/ext/skin/www.wanwei.com.cn/new/images/logo.png?",file: "logo.png",*/link: p + c.version + "&m=h&e=f",linktarget: "_top",margin: 8,hide: true,position: "top-right"};
    m(l, {cursor: "pointer",position: "absolute","z-index": 100,opacity: 0});
...
(function(c) {
    ...
    f.menu = function(m, n, B, t) {
        var x = B, z = m, y = n, o = t, q = new f.overlay(y + "_overlay", B), r = k.extend({fontcase: g,fontcolor: b,fontsize: 11,fontweight: g,activecolor: a,overcolor: a}, B.getComponentSettings("tooltip")), p, A = [];
        function w() {
            p = u(h);
            p.id = y;
            ...
            if (E) {
                var C = "#" + n + " ." + d;
                j(C, {"background-image": E.src,height: E.height,color: r.fontcolor,"padding-left": E.width,font: r.fontweight + " " + r.fontsize + "px Arial,Helvetica,sans-serif","line-height": E.height,"text-transform": (r.fontcase == "upper") ? "uppercase" : g});
                j(C + ":hover", {"background-image": D.src ? D.src : g,color: r.overcolor});
                j(C + ".active", {"background-image": F.src ? F.src : g,color: r.activecolor})
            }
            q.setContents(p)
        }
        this.element = function() {
        ...
        function s(C) {
            ...
            return D ? D : {width: 0,height: 0,src: g}
        }
        this.show = q.show;
        this.hide = q.hide;
    ...
    j(e(h + " " + d), {"background-repeat": "no-repeat",cursor: "pointer",position: "relative"})
})(jwplayer);
(function(b) {
    var a = jwplayer.utils, d = jwplayer.events, e = undefined, c = true, f = false;
    b.model = function(j) {
        var p = this, l, r, s = a.getCookies(), g = {controlbar: {},display: {}}, n = {autostart: f,controls: c,debug: e,fullscreen: f,height: 320,mobilecontrols: f,mute: f,playlist: [],playlistposition: "none",playlistsize: 180,repeat: f,skin: e,stretching: a.stretching.UNIFORM,width: 480,volume: 90};
        function o(t) {
            for (var u in t) {
                t[u] = a.serialize(t[u])
            }
        ...
        function q() {
            ...
            a.extend(p, {id: j.id,state: d.state.IDLE,duration: -1,position: 0,buffer: 0}, p.config);
            p.playlist = [];
            p.setItem(0);
        ...
        p.setFullscreen = function(t) {
            if (t != p.fullscreen) {
                p.fullscreen = t;
                p.sendEvent(d.JWPLAYER_FULLSCREEN, {fullscreen: t})
            }
        };
        p.setPlaylist = function(t) {
            p.playlist = h(t);
            if (p.playlist.length == 0) {
                p.sendEvent(d.JWPLAYER_ERROR, {message: "Error loading playlist: No playable sources found"})
            } else {
                p.sendEvent(d.JWPLAYER_PLAYLIST_LOADED, {playlist: t});
                p.item = -1;
                p.setItem(0)
            }
        };
        ...
        p.setItem = function(t) {
            ...
            if (u != p.item) {
                p.item = u;
                p.sendEvent(d.JWPLAYER_PLAYLIST_ITEM, {index: p.item})
            }
        };
...
(function(k) {
    var e = k.html5, r = k.utils, n = r.css, s = r.transitionStyle, c = "relative", d = "absolute", g = "hidden", j = "100%", q = "opacity .15s, visibility .15s, left .01s linear", l = ".jwoverlay", a = "jwcontents", p = "top", f = "bottom", h = "right", m = "left", t = "#ffffff", u = undefined, b = document, o = {fontcase: u,fontcolor: t,fontsize: 12,fontweight: u,activecolor: t,overcolor: t};
    e.overlay = function(H, K, E) {
        ...
        function D() {
            ...
            J = y("arrow", "jwarrow")[1];
            N = J.height;
            n(A("jwarrow"), {position: d,bottom: M ? u : 0,top: M ? 0 : u,width: J.width,height: N,left: "50%"});
            P(p, m);
            P(f, m);
            P(p, h);
            P(f, h);
            ...
            P(f);
            y("background", "jwback");
            n(A("jwback"), {left: z.left,right: z.right,top: z.top,bottom: z.bottom});
            Q = O(a, C);
            n(A(a) + " *", {color: v.fontcolor,font: v.fontweight + " " + (v.fontsize) + "px Arial,Helvetica,sans-serif","text-transform": (v.fontcase == "upper") ? "uppercase" : u});
            if (M) {
                r.transform(A("jwarrow"), "rotate(180deg)")
            }
            n(A(), {padding: (z.top + 1) + "px " + z.right + "px " + (z.bottom + 1) + "px " + z.left + "px"});
            L.showing = false
        }
        function A(R) {
            return "#" + x + (R ? " ." + R : "")
        ...
        function y(R, T) {
            var S = G(R), U = O(T, C);
            n(A(T.replace(" ", ".")), {"background-image": S.src});
            return [U, S]
        }
        function P(X, W) {
            if (!W) {
            ...
            var T = y("cap" + X + W, "jwborder jw" + X + (W ? W : "")), R = T[0], U = T[1], S = {"background-image": U.src,width: (X == m || W == m || X == h || W == h) ? U.width : u,height: (X == p || W == p || X == f || W == f) ? U.height : u};
            S[X] = ((X == f && !M) || (X == p && M)) ? N : 0;
            if (W) {
                S[W] = 0
            }
            n(A(R.className.replace(/ /g, ".")), S);
            var V = {}, Z = {}, Y = {left: U.width,right: U.width,top: (M ? N : 0) + U.height,bottom: (M ? 0 : N) + U.height};
            if (W) {
                V[W] = Y[W];
                V[X] = 0;
                Z[X] = Y[X];
        ...
        function w() {
            ...
            n(A(), {"margin-left": Math.round(I - C.clientWidth / 2)});
            n(A("jwarrow"), {"margin-left": Math.round((J.width / -2) - I)})
        }
        ...
        function G(R) {
            ...
            if (S) {
                ...
                return {width: 0,height: 0,src: "",image: u,ready: false}
            }
        }
        L.show = function() {
            L.showing = true;
    ...
    n(l, {position: d,visibility: g,opacity: 0});
    n(l + " .jwcontents", {position: c,"z-index": 1});
    n(l + " .jwborder", {position: d,"background-size": j + " " + j}, true);
    n(l + " .jwback", {position: d,"background-size": j + " " + j});
    s(l, q)
})(jwplayer);
(function(b) {
...
(function(g) {
    var b = "#FFFFFF", d = "#CCCCCC", l = "#333333", h = "#999999", k = "normal", f = {size: 180,backgroundcolor: l,fontcolor: h,overcolor: d,activecolor: d,titlecolor: d,titleovercolor: b,titleactivecolor: b,fontweight: k,titleweight: k,fontsize: 11,titlesize: 13}, q = jwplayer.events, o = jwplayer.utils, m = o.css, p = ".jwplaylist", n = document, a = "absolute", c = "relative", e = "hidden", j = "100%";
    g.playlistcomponent = function(I, T) {
        var N = I, B = N.skin, s = o.extend({}, f, N.skin.getComponentSettings("playlist"), T), O, C, r, w, u, A = -1, D, t, v = 60, x = {background: undefined,divider: undefined,item: undefined,itemOver: undefined,itemImage: undefined,itemActive: undefined};
        this.element = function() {
            return O
        };
        ...
        function G() {
            var X = 0, W = 0, U = 0;
            o.clearCss(z());
            m(z(), {"background-color": s.backgroundcolor});
            m(z("jwlist"), {"background-image": x.background ? " url(" + x.background.src + ")" : ""});
            m(z("jwlist *"), {color: s.fontcolor,font: s.fontweight + " " + s.fontsize + "px Arial, Helvetica, sans-serif"});
            if (x.itemImage) {
            ...
            if (x.divider) {
                m(z("jwplaylistdivider"), {"background-image": "url(" + x.divider.src + ")","background-size": j + " " + x.divider.height + "px",width: j,height: x.divider.height})
            }
            m(z("jwplaylistimg"), {height: U,width: W,margin: X ? (X + X + X + X) : "0 5px 0 0"});
            m(z("jwlist li"), {"background-image": x.item ? "url(" + x.item.src + ")" : "",height: v,"background-size": j + " " + v + "px",cursor: "pointer"});
            ...
            m(z("jwlist li.active .jwtitle"), {color: s.titleactivecolor});
            ...
            m(z("jwlist li:hover .jwtitle"), {color: s.titleovercolor});
            m(z("jwtextwrapper"), {height: v - 5,position: c});
            m(z("jwtitle"), {height: 15,overflow: "hidden",display: "inline-block",width: j,color: s.titlecolor,"margin-top": X ? X : 7,"line-height": 13,"font-size": s.titlesize,"font-weight": s.titleweight});
            m(z("jwdescription"), {display: "block","font-size": s.fontsize,"line-height": 19,"margin-top": 5,overflow: "hidden",height: v,position: c})
        }
        function F() {
            var U = R("ul", "jwlist");
        ...
        function H(X) {
            ...
            if (M() && (ac.image || ac["playlist.image"] || x.itemImage)) {
                ...
                m("#" + ab.id + " .jwplaylistimg", {"background-image": Z ? "url(" + Z + ")" : null});
                S(ab, Y)
            }
    ...
    m(p, {position: a,width: j,height: j});
    o.dragStyle(p, "none");
    m(p + " .jwplaylistimg", {position: c,width: j,"float": "left",margin: "0 5px 0 0",background: "#000",overflow: e});
    m(p + " .jwlist", {position: a,width: j,"list-style": "none",margin: 0,padding: 0});
    m(p + " .jwlistcontainer", {position: a,overflow: e,width: j,height: j});
    m(p + " .jwlist li", {width: j});
    m(p + " .jwtextwrapper", {overflow: e});
    m(p + " .jwplaylistdivider", {position: a})
})(jwplayer.html5);
(function(b) {
    ...
    b.playlistloader = function() {
        ...
        function h(k) {
            try {
                ...
                if (m && m.length && m[0].sources && m[0].sources.length && m[0].sources[0].file) {
                    g.sendEvent(c.JWPLAYER_PLAYLIST_LOADED, {playlist: m})
                } else {
        ...
        function e(k) {
            g.sendEvent(c.JWPLAYER_ERROR, {message: k ? k : "Error loading file"})
        }
    }
})(jwplayer.html5);
(function(k) {
    ...
    k.playlistslider = function(T, K, H, X) {
        ...
        function G() {
            ...
            ah(o, ab, C, true);
            ah(m, aa, C);
            n(W(o), {top: y.height,bottom: aa.height});
            ah(u, E, ac);
            ah(j, w, ac, true);
            ah(t, O, ac);
            n(W(j), {top: E.height,bottom: O.height});
            I();
            if (Y) {
        ...
        function ah(am, al, ak, aj) {
            ...
            if (am) {
                an.className = am;
                if (al) {
                    n(W(am), {"background-image": al.src ? al.src : v,"background-repeat": aj ? "repeat-y" : "no-repeat",height: aj ? v : al.height})
                }
            }
            if (ak) {
                ak.appendChild(an)
        ...
        function F(aj) {
            ...
            return ak ? ak : {width: 0,height: 0,src: v}
        }
        ...
        function R(aj) {
            ...
            if (aj > 1) {
                ...
                ai = true;
                n(W(c), {height: Math.max(C.clientHeight * aj, E.height + O.height)})
            }
            n(W(), {visibility: ai ? "visible" : "hidden"});
            if (Y) {
        ...
        var L = this.thumbPosition = function(aj) {
            ...
            n(W(c), {top: S + (C.clientHeight - ac.clientHeight) * ag});
            if (X) {
    ...
    n(d(b), {position: g,height: l,visibility: "hidden",right: 0,top: 0,cursor: "pointer","z-index": 1});
    n(d(b) + " *", {position: g,width: l,"background-position": "center","background-size": l + " " + l});
    n(d(p, q, u), {top: 0});
    n(d(h, m, t), {bottom: 0})
})(jwplayer.html5);
(function(e) {
    ...
    e.rightclick = function(r, p) {
        var x = r, q, w = l.extend({aboutlink: m + e.version + "&m=h&e=o",abouttext: a + e.version + "..."}, p), n = false, y, s;
        function v() {
    ...
    j(h, {"background-color": c,"-webkit-border-radius": 5,"-moz-border-radius": 5,"border-radius": 5,height: "auto",border: "1px solid #bcbcbc","font-family": '"MS Sans Serif", "Geneva", sans-serif',"font-size": 10,width: 320,"-webkit-box-shadow": d,"-moz-box-shadow": d,"box-shadow": d,position: "absolute","z-index": 999}, true);
    j(h + " div", {padding: "8px 21px",margin: "0px","background-color": c,border: "none","font-family": '"MS Sans Serif", "Geneva", sans-serif',"font-size": 10,color: "inherit"}, true);
    j(g, {padding: "8px 21px","text-align": "left",cursor: "pointer"}, true);
    j(g + ":hover", {"background-color": "#595959",color: c}, true);
    j(g + " a", {"text-decoration": b,color: "#000"}, true);
    j(h + " hr", {width: f,padding: 0,margin: 0,border: "1px #e9e9e9 solid"}, true)
})(jwplayer.html5);
(function(f) {
    ...
    f.setup = function(t, I, J) {
        ...
        function s(S, U, T) {
            x.push({name: S,method: U,depends: T})
        }
        function H() {
        ...
        function y(S) {
            w = true;
            A.sendEvent(m.JWPLAYER_ERROR, {message: S});
            q.setupError(S)
        }
        l.extend(this, A);
        this.start = H;
    ...
    b.skinloader = function(f, l, h) {
        ...
        function y(F) {
            ...
            for (var P = 0; P < M.length; P++) {
                var K = k(M[P].getAttribute("name")), J = {settings: {},elements: {},layout: {}}, O = m(m(M[P], "elements")[0], "element");
                j[K] = J;
                ...
                if (T && T.childNodes.length > 0) {
                    ...
                    for (var D = 0; D < U.length; D++) {
                        ...
                        for (var C = 0; C < V.length; C++) {
                            var A = V[C];
                            H.elements.push({type: A.tagName});
        ...
        function q(F, E) {
            ...
            j[E].elements[A] = {height: 0,width: 0,src: "",ready: false,image: D};
            D.onload = function(I) {
                r(D, A, E)
            };
...
(function(c) {
    ...
    c.html5.video = function(X) {
        ...
        function Y(af) {
            ...
            if (e == b.PLAYING && !H) {
                p = ab(w.currentTime);
                s(d.JWPLAYER_MEDIA_TIME, {position: p,duration: ad});
        ...
        function n(af) {
            ...
            O.sendEvent(d.JWPLAYER_MEDIA_ERROR, {message: "Error loading media: File could not be played"});
            x(b.IDLE)
        }
        function l(ai) {
            var af;
        ...
        function j(ag) {
            var af = l(ag);
            if (af) {
                O.sendEvent(d.JWPLAYER_MEDIA_LEVELS, {levels: af,currentQuality: F})
            }
        }
        function Q(af) {
            if (af.label) {
        ...
        function I() {
            if (!H) {
                s(d.JWPLAYER_MEDIA_SEEK, {position: p,offset: w.currentTime})
            }
        }
        ...
        function k(af) {
            s(d.JWPLAYER_MEDIA_VOLUME, {volume: Math.round(w.volume * 100)});
            s(d.JWPLAYER_MEDIA_MUTE, {mute: w.muted})
        }
        g.mute = function(af) {
            if (!a.exists(af)) {
                af = !w.mute
        ...
        function x(af) {
            ...
            if (e != af) {
                var ag = e;
                e = af;
                s(d.JWPLAYER_PLAYER_STATE, {oldstate: ag,newstate: af})
            }
        }
        function h() {
            if (!t) {
            ...
            if (af != K) {
                K = af;
                s(d.JWPLAYER_MEDIA_BUFFER, {bufferPercent: Math.round(K * 100)})
            }
            if (af >= 1) {
                clearInterval(o)
            }
        ...
        g.setCurrentQuality = function(ag) {
            ...
            if (ag >= 0) {
                if (J && J.length > ag) {
                    F = ag;
                    s(d.JWPLAYER_MEDIA_LEVEL_CHANGED, {currentQuality: ag,levels: l(J)});
...
(function(l) {
    ...
    l.view = function(M, H) {
        ...
        function C() {
            ...
            if (L.edition) {
                au = new l.rightclick(L, {abouttext: J.abouttext,aboutlink: J.aboutlink})
            } else {
        ...
        function X(aT, aS) {
            ...
            var aU = (aS.y > aS.height / 2), aV = {x: aT.x,y: aU ? aT.y : aS.bottom,width: aT.width}
        }
        function Z(aS) {
            aS = aS && !T;
            r(ar(y), {visibility: aS ? "visible" : "hidden",opacity: aS ? 1 : 0})
        }
        function aD() {
            ah = k;
            ad(false);
        ...
        this.setControls = function(aT) {
            ...
            if (aS != aU) {
                ...
                ax.sendEvent(a.JWPLAYER_CONTROLS, {controls: aS})
            }
        };
        this.getSafeRegion = function() {
            ...
            return {x: 0,y: aZ ? aS.y : 0,width: aZ ? aS.width : 0,height: aZ ? aS.height : 0}
        };
        this.destroy = function() {
    ...
    r("." + o, {position: "relative",opacity: 0,"min-height": x.isMobile() ? 200 : 0,"-webkit-transition": v,"-moz-transition": v,"-o-transition": v});
    r("." + q, {position: j,left: 0,right: 0,top: 0,bottom: 0,"-webkit-transition": v,"-moz-transition": v,"-o-transition": v});
    r("." + y + " ,." + c, {position: j,height: n,width: n,"-webkit-transition": v,"-moz-transition": v,"-o-transition": v});
    r("." + y, {visibility: "hidden",overflow: "hidden",cursor: "pointer"});
    r("." + y + " video", {background: "transparent",width: n,height: n});
    r("." + e, {position: j,height: n,width: n,display: "none"});
    r("." + z, {position: j,top: 0,left: 0,bottom: 0,right: 0,display: "none"});
    r(b, {width: n,height: n,left: 0,right: 0,top: 0,bottom: 0,"z-index": 1000,position: "fixed"}, k);
    r(b + " ." + q, {left: 0,right: 0,top: 0,bottom: 0}, k);
    r(b + " ." + e, {display: "none"}, k);
    r("." + o + " .jwuniform", {"background-size": "contain" + u});
    r("." + o + " .jwfill", {"background-size": "cover" + u,"background-position": "center"});
    r("." + o + " .jwexactfit", {"background-size": n + " " + n + u})
})(jwplayer.html5);
(function(b) {
